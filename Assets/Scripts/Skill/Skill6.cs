...
public class Skill6 : SkillActivie
{
    private void Start()
    {
        base.FindPlayer();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Enemy"))
        {
            ...
            {
                playerManager.HealHP(playerLife.GetHPTotal() / (11 - skillController.GetLevelSkill(index)));
                Skill5Active();
