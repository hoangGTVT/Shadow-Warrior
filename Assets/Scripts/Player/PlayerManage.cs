...
public class PlayerManage : MonoBehaviour
{
    ...
    {
        if( _playerMoment.IsGrounded() == true&& InputManager.instance.SetHorizontal()==0)
        {
    ...
    public void ChangeBackPack()
    {
        if (backPack != null)
        {
            PlayerCustomization(_backPack._backPack, backPack[backPackIndex].GetSpriteHeadIdle);
        }
    }
